...
%% 使用randn函数产生均值为0，方差σ^2 = 1，标准差σ=1的正态分布的随机矩阵，2000个数据，分两类。
>>>>>>> c8454c887772597734e7dc33442262361d4f85b8
...
=======
legend({'class1_train','class1_test'},'Location','northwest')
  
figure
plot(class1_test(:,1),class1_test(:,2),'rs'); hold on;
plot(class2_test(:,1),class2_test(:,2),'bs')
grid on;
legend({'class2_train','class2_test'},'Location','northwest') 
